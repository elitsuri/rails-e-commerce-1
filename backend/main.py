...
app = FastAPI(
    ...
    description="E-commerce store with Rails, Stripe, PostgreSQL, and Active Storage",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "Rails E-Commerce"}
